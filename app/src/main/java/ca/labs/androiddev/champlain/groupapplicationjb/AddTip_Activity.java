...
public class AddTip_Activity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    private DrawerLayout dl;
    private ActionBarDrawerToggle tg;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_tip_);
    ...
    public void btnAdd_onClick(View v){
        ...
        DBManager db = new DBManager(this);
            ...
            db.addTip(desc);
            Toast.makeText(getApplication(), "Tip added", Toast.LENGTH_LONG).show();
